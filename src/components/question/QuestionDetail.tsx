...
import { getUserBojId } from '../../services/userService';
...
const QuestionDetail: React.FC = () => {
  ...
  const [userBojId, setUserBojId] = useState<string | null>(null);
  ...
  const handleCommentUpdate = async (commentId: string, newContent: string, author: string) => {
    if (!user) return;
    try {
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden mb-8">
        <div className="p-6">
          ...
          <div className="prose max-w-none mb-6">
            <Link to={`https://www.acmicpc.net/problem/${question.p_num}`} className=' text-blue-500 text-sm'>
